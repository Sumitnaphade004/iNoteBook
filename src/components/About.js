...
const About = () => {
  return (
    <div className="container" style={{"backgroundColor": "#212529"}}>
      <div className="card border-0" style={{"backgroundColor": "#212529", "color": "#ffffff"}}>
        <div className="card-body p-3">
          ...
          <div className="row g-4">
            <div className="col-md-4">
              <div className="card h-100 border-primary" style={{"backgroundColor": "#2B3035", "color": "#ffffff"}}>
                <div className="card-body text-center">
                  <h3>📝 Create Notes</h3>
                  <p>
                    Quickly add notes for important tasks, ideas, reminders,
                    and information you want to save.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-md-4">
              <div className="card h-100 border-success" style={{"backgroundColor": "#2B3035", "color": "#ffffff"}}>
                <div className="card-body text-center">
                  <h3>👀 View Notes</h3>
                  <p>
            ...
            <div className="col-md-4">
              <div className="card h-100 border-danger" style={{"backgroundColor": "#2B3035", "color": "#ffffff"}}>
                <div className="card-body text-center">
          ...
          <div className="mt-5">
            ...
            <ul className="list-group border-0">
              <li className="list-group-item border-0" style={{"backgroundColor": "#212529", "color": "#ffffff"}}>
